...
# https://buildpacks.io/
readonly lGitHubUser="buildpacks"
readonly lGitHubRepo="pack"
readonly lGitHubApp="pack"
...
readonly lGitHubAppURL="https://github.com/${lGitHubUserRepo}/releases/download/${lAppLatestReleaseVersion}/${lGitHubApp}-${lAppLatestReleaseVersion}-linux.tgz"
